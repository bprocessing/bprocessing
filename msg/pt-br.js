var MSG = {
  ...
  catCond: "Instruções Condicionais",
  catLoops: "Ciclos",
  catLogic: "Operadores booleanos",
  catMath: "Operadores aritméticos",
  catText: "Operadores de texto",
  catCond: "Instruções condicionais",
  // catLogic: "Instruções condicionais",
  // catMath: "Matemática",
  // catText: "Texto",
  catLists: "Listas",
  catColour: "Cor",
  catVariables: "Variáveis e constantes",
  ...
  welcome: "Programar processing com blocos.",
  catProcessing: "Processing",
  catMouse: "Mouse inputs",
